...
public class RespuestaInformeConsolidado {
        ...
        public static ConsultaResponse generarRespuestaError(String idConsulta,
                ...
                return ConsultaResponse.builder()
                                ...
                                .resultado(new ConsultaResponse.Resultado()) // No incluye el objeto resultado en este
                                                                             // caso
        ...
        public static ConsultaResponse generarRespuestaOK(String idConsulta,
                ...
                try {
                        ...
                        RespuestaMaatInformeSimple respuestaMaat = objectMapper.readValue(json,
                                        RespuestaMaatInformeSimple.class);

                        RutInfo rutInfo = UtilesVarios
                                        .validarRetornarRut(respuestaMaat.getDatos().getDatosPersonales().getRut());

                        int rut = rutInfo.getRut();
                        String digito = rutInfo.getDigitoVerificador();

                        // Mapeo de datos personales
                        cl.veridico.informes.services.Datos.DatosPersonales datosPersonalesMaat = respuestaMaat
                                        .getDatos()
                                        .getDatosPersonales();
                                                        ...
                                                        .trabajadoresAfectados(deuda.getTrabajadores_Afectados()
                                                                        ...
                                                                        .map(trab -> ConsultaResponse.Resultado.DeudaPrevisional.TrabajadorAfectado
                                                                                        ...
                                                                                        .nombreTrabajador(trab
                                                                                                        .getNombre_trabajador())
                                                                                        .periodoDeuda(UtilesVarios
                                                                                                        .convertirFechaISO(
                                                                                                                        trab.getPeriodo_deuda()))
                                                                                        .montoDeudaPesos(UtilesVarios
                                                                                                        .convertirMonto(trab
                                                                                                                        .getMonto_deuda_pesos()))
                        ...
                        List<ConsultaResponse.Resultado.DeudaLaboral> deudasLaborales = respuestaMaat.getDatos()
                                        ...
                                        .map(deuda -> ConsultaResponse.Resultado.DeudaLaboral.builder()
                                                        .fechaBoletin(UtilesVarios
                                                                        .convertirFechaISO(deuda.getFecha_Boletin()))
                        ...
                        // Mapeo de protestos
                        List<ConsultaResponse.Resultado.Protesto> protestos = respuestaMaat.getDatos().getProtestos()
                                        .getData()
                                        .stream()
                                        .map(prot -> ConsultaResponse.Resultado.Protesto.builder()
                                                        ...
                                                        .montoProtesto(UtilesVarios
                                                                        .convertirMonto(prot.getMonto_protesto()))
                        ...
                        // Mapeo de Infocom
                        List<ConsultaResponse.Resultado.Infocom> infocom = respuestaMaat.getDatos().getInfocom()
                                        .getData()
                                        .stream()
                        ...
                        List<ConsultaResponse.Resultado.DeudaComercio> deudasComercio = respuestaMaat.getDatos()
                                        .getDeudasComercio()
                                        .getData()
                                        .stream()
                                        .map(deuda -> ConsultaResponse.Resultado.DeudaComercio.builder()
                                                        .fechaVencimiento(UtilesVarios.convertirFechaISO(
                                                                        deuda.getFecha_vencimiento()))
                        ...
                        return ConsultaResponse.builder()
                                        ...
                                        .resultado(new ConsultaResponse.Resultado()) // No incluye el objeto resultado
                                                                                     // en este caso
                                        .build();
                }
        }
