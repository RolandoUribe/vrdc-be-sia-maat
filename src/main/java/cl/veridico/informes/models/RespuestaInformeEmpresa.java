...
public class RespuestaInformeEmpresa {
        ...
        public static ConsultaResponseEmpresa generarRespuestaOK(String idConsulta,
                ...
                try {
                        ...
                        // System.out.println("RespuestaInformeEmpresa->generarRespuestaOK->Respuesta
                        // Maat: [" + json + "]");
                        ...
                        ConsultaResponseEmpresa.Resultado.IdentificacionJuridica datosIdJuridica = ConsultaResponseEmpresa.Resultado.IdentificacionJuridica
                                        ...
                                        .fechaInicioActividades(
                                                        UtilesVarios.convertirFechaISO(datosIdJuridicaMaat
                                                                        .getFechaInicioActividades()))
                                        .actividadPrincipal(datosIdJuridicaMaat.getActividadPrincipal() != null
                                                        ? datosIdJuridicaMaat.getActividadPrincipal().trim()
                                                        : "")
                                        .segmentoEmpresa(datosIdJuridicaMaat.getSegmentoEmpresa())
                                        .numeroEmpleados(datosIdJuridicaMaat.getNumeroEmpleados())
                                        .regimenTributarioEspecial(
                                                        datosIdJuridicaMaat.getRegimenTributarioEspecial() != null
                                                                        ? datosIdJuridicaMaat
                        ...
                        List<ConsultaResponseEmpresa.Resultado.TimbrajeAutorizado> datosTimbrajesAutorizados = respuestaMaat
                                        ...
                                        .map(timaut -> ConsultaResponseEmpresa.Resultado.TimbrajeAutorizado.builder()
                                                        ...
                                                        .fechaAutorizacion(UtilesVarios.convertirFechaISO(
                                                                        timaut.getFechaAutorizacion()))
                                                        .build())
                                        .toList();
                        ...
                        List<ConsultaResponseEmpresa.Resultado.ActividadEconomica> datosActividadEconomicas = respuestaMaat
                                        ...
                                        .map(acteco -> ConsultaResponseEmpresa.Resultado.ActividadEconomica.builder()
                                                        ...
                                                        .fechaInicio(UtilesVarios
                                                                        .convertirFechaISO(acteco.getFechaInicio()))
                                                        .fechaTermino(UtilesVarios
                                                                        .convertirFechaISO(acteco.getFechaTermino()))
                                                        .afectoIva(acteco.getAfectoIva())
                                                        .categoriaActividadEconomica(
                                                                        acteco.getCategoriaActividadEconomica())
                                                        .build())
                                        .toList();
                        ...
                        if (respuestaMaat.getDatosEmpresa().getSociedadesEmpresariales() != null) {
                                ...
                                datosSociedadEmpresariales = respuestaMaat
                                                ...
                                                .stream()
                                                .map(socemp -> ConsultaResponseEmpresa.Resultado.SociedadEmpresarial
                                                                .builder()
                                                                ...
                                                                .razonSocial(socemp.getRazonSocial() != null
                                                                                ? socemp.getRazonSocial().trim()
                                                                                : "")
                                                                .fechaRelacion(UtilesVarios.convertirFechaISO(
                                                                                socemp.getFechaRelacion()))
                                                                .build())
                                                .toList();
                        }
                        ...
                        ListaOError<DatosEmpresa.SociedadPersona> listaOriginal = datos != null
                                        ? datos.getSociedadesPersonas()
                                        : null;
                        ...
                        if (listaOriginal != null && listaOriginal.getData() != null) {
                                for (DatosEmpresa.SociedadPersona sociedad : listaOriginal.getData()) {
                                        ...
                                        ListaOError<DatosEmpresa.SociedadPersona.Socio> listaSocios = sociedad
                                                        .getSocios();
                                        ...
                                        if (listaSocios != null && listaSocios.getData() != null) {
                                                socios = listaSocios.getData().stream()
                                                                .map(socio -> ConsultaResponseEmpresa.Resultado.SociedadPersona.Socio
                                                                                .builder()
                                                                                .rutSocio(UtilesVarios
                                                                                                .validarRetornarRut(
                                                                                                                socio.getRutSocio())
                                        ...
                                        ConsultaResponseEmpresa.Resultado.SociedadPersona nuevaSociedad = ConsultaResponseEmpresa.Resultado.SociedadPersona
                                                        ...
                                                        .rut(UtilesVarios.validarRetornarRut(sociedad.getRut())
                                                                        .getRut())
                        ...
                        ConsultaResponseEmpresa.Resultado.ResumenTotalMorosidad datosResumenTotalMorosidad = ConsultaResponseEmpresa.Resultado.ResumenTotalMorosidad
                                        ...
                                        .montoTotalProtestos(UtilesVarios.convertirMonto(
                                                        respuestaMaat.getDatosEmpresa().getResumenTotalesMorosidades()
                                                                        .getMontoTotalProtestos()))
                                        .montoTotalInfocom(UtilesVarios.convertirMonto(
                                                        respuestaMaat.getDatosEmpresa().getResumenTotalesMorosidades()
                                                                        .getMontoTotalInfocom()))
                                        .montoTotalDeudasPrevisionales(
                                                        UtilesVarios.convertirMonto(respuestaMaat.getDatosEmpresa()
                                                                        .getResumenTotalesMorosidades()
                                                                        .getMontoTotalDeudasPrevisionales()))
                                        .montoTotalDeudasLaborales(UtilesVarios.convertirMonto(respuestaMaat
                                                        .getDatosEmpresa()
                                                        .getResumenTotalesMorosidades().getMontoTotalDeudasLaborales()))
                                        .montoTotalDeudasComercio(UtilesVarios.convertirMonto(respuestaMaat
                                                        .getDatosEmpresa()
                        ...
                        // Mapeo de protestos
                        List<ConsultaResponseEmpresa.Resultado.Protesto> datosProtestos = respuestaMaat
                                        .getDatosEmpresa()
                        ...
                        List<ConsultaResponseEmpresa.Resultado.MorosidadVigente> datosMorosidadesVigentes = respuestaMaat
                                        ...
                                        .map(morvig -> ConsultaResponseEmpresa.Resultado.MorosidadVigente.builder()
                                                        .fechaVencimiento(UtilesVarios.convertirFechaISO(
                                                                        morvig.getFechaVencimiento()))
                        ...
                        // Mapeo Boletin Maat
                        List<ConsultaResponseEmpresa.Resultado.BoletinMaat> datosBoletinesMaat = respuestaMaat
                                        .getDatosEmpresa()
                                        .getBoletinesMaat().getData()
                                        .stream()
                                        .map(bolmaat -> ConsultaResponseEmpresa.Resultado.BoletinMaat.builder()
                                                        .fechaVencimiento(UtilesVarios.convertirFechaISO(
                                                                        bolmaat.getFechaVencimiento()))
                        ...
                        ConsultaResponseEmpresa.Resultado.ResumenConsolidado datosResumenConsolidado = ConsultaResponseEmpresa.Resultado.ResumenConsolidado
                                        .builder()
                                        .eventosQuiebras(respuestaMaat.getDatosEmpresa().getResumenConsolidado()
                                                        .getEventosQuiebras())
                                        .bancosRelacionados(
                                                        respuestaMaat.getDatosEmpresa().getResumenConsolidado()
                                                                        .getBancosRelacionados() != null
                                                                                        ? respuestaMaat.getDatosEmpresa()
                                                                                                        .getResumenConsolidado()
                                                                                                        .getBancosRelacionados()
                                                                                                        .trim()
                                                                                        : "")
                                        .ordenNoPago(respuestaMaat.getDatosEmpresa().getResumenConsolidado()
                                                        .getOrdenNoPago())
                                        .vehiculos(respuestaMaat.getDatosEmpresa().getResumenConsolidado()
                                                        .getVehiculos())
                                        .bienesRaices(respuestaMaat.getDatosEmpresa().getResumenConsolidado()
                                                        .getBienesRaices())
                                        .exportaciones(respuestaMaat.getDatosEmpresa().getResumenConsolidado()
                                                        .getExportaciones())
                                        .importaciones(respuestaMaat.getDatosEmpresa().getResumenConsolidado()
                                                        .getImportaciones())
                                        ...
                                        .sociedades(respuestaMaat.getDatosEmpresa().getResumenConsolidado()
                                                        .getSocieades())
                        ...
                        // Mapeo Vehiculos
                        List<ConsultaResponseEmpresa.Resultado.Vehiculo> datosVehiculos = respuestaMaat
                                        .getDatosEmpresa()
                        ...
                        List<ConsultaResponseEmpresa.Resultado.BienRaiz> datosBienesRaices = respuestaMaat
                                        .getDatosEmpresa()
                        ...
                        List<ConsultaResponseEmpresa.Resultado.Exportacion> datosExportaciones = respuestaMaat
                                        .getDatosEmpresa()
                        ...
                        List<ConsultaResponseEmpresa.Resultado.Importacion> datosImportaciones = respuestaMaat
                                        .getDatosEmpresa()
                        ...
                        // Mapeo de Prendas
                        List<ConsultaResponseEmpresa.Resultado.Prenda> datosPrendas = respuestaMaat.getDatosEmpresa()
                                        .getPrendas()
                                        .getData()
                                        .stream()
                        ...
                        List<ConsultaResponseEmpresa.Resultado.ConsultaRut> datosConsultasAlRut = respuestaMaat
                                        .getDatosEmpresa()
                        ...
                        ConsultaResponseEmpresa.Resultado.Score datosScore = ConsultaResponseEmpresa.Resultado.Score
                                        .builder()
                                        .puntaje(score)
        ...
        public static class ConsultaResponseEmpresa {
                ...
                public static class Resultado {
                        ...
                        @Builder
                        @JsonIgnoreProperties(ignoreUnknown = true)
                        public static class SociedadPersona {
